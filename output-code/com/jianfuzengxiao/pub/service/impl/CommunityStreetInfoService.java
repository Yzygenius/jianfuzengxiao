...
@Autowired 
private ICommunityStreetInfoMDAO communityStreetInfoMDAO; 		/**插入*/
	    @Override
		...
		/**查询集合列表*/
	    @Override
	     public List<CommunityStreetInfoMVO> queryList(CommunityStreetInfoMVO communityStreetInfo) throws SysException, AppException {
 		return communityStreetInfoMDAO.queryList(communityStreetInfo);
     }
		/**查询对象*/
	    @Override
	     public CommunityStreetInfoMVO queryBean(CommunityStreetInfoMVO communityStreetInfo) throws SysException, AppException {
 		 return communityStreetInfoMDAO.queryBean(communityStreetInfo);
     }
		/**分页查询*/
	    @Override
	     public PageInfo queryPage(CommunityStreetInfoMVO communityStreetInfo, PageInfo pagInfo) throws SysException, AppException {
