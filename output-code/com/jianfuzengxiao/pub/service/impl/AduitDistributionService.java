...
@Autowired 
private IAduitDistributionMDAO aduitDistributionMDAO; 		/**插入*/
	    @Override
		...
		/**查询集合列表*/
	    @Override
	     public List<AduitDistributionMVO> queryList(AduitDistributionMVO aduitDistribution) throws SysException, AppException {
		...
		/**分页查询*/
	    @Override
	     public PageInfo queryPage(AduitDistributionMVO aduitDistribution, PageInfo pagInfo) throws SysException, AppException {
