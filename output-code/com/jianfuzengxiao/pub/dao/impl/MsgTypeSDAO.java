...
@Override
    public MsgTypeMVO insert(final MsgTypeMVO entity) throws SysException { 
        ...
        try {
            ...
            jdbcTemplate.update(
          	...
          	throw new SysException("10000", "增加MSG_TYPE错误", e);
          }
          return entity;
       }
    @Override
    public int update(MsgTypeMVO entity) throws SysException {
        ...
        try {
            ...
            throw new SysException("10000", "更新MSG_TYPE错误", e);
         }
        return rowsAffected;
    }
    @Override
    public int delete(MsgTypeMVO entity) throws SysException {
        ...
        try {
            ...
            throw new SysException("10000", "删除MSG_TYPE错误", e);
        }
        return rowsAffected;
    }
    @Override
    public List<MsgTypeMVO> queryList(MsgTypeMVO entity) throws SysException {
        StringBuilder sql = new StringBuilder();
        sql.append("SELECT msg_type_id,msg_type_name,list_order,date_format(create_time,'%Y-%m-%d %H:%i:%s')create_time,date_format(update_time,'%Y-%m-%d %H:%i:%s')update_time,sts ");
        ...
        try {
            ...
            throw new SysException("10000", "查询MSG_TYPE错误", e);
        }
        return resultList;
    }
    @Override
