...
//var page = 1;
/* 当前页数， 总页数 */
function pageinfoTradeInfo(page, pageCount,element){
    ...
    if (pageCount <= pageGeShu) {
        ...
        if(page == 1){
            ...
            for(var i = 0; i < pageCount; i++){
                ...
                var p = (i + 1);
                if(i == 0){
                    str += '<span class="active" onclick="getTradeMessage('+p+')">'+p+'</span>';
                }else{
                    str += '<span onclick="getTradeMessage('+p+')">'+p+'</span>';
                }
            }
