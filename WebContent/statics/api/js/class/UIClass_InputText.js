...
InputText.DisTypeTable = "DisTypeTable";

function InputText(targetId,typeFlg,disTypeFlg,lengthFlg,bitFlg){
	//绑定元素
...
InputText.prototype.setCss = function(){
    ...
    //设置样式
    var css;
    if(this.disType == InputText.DisTypeTable){
    	css = {
	        "width": "100%",
	        "height": "40px",
