var bottom = '<div id="bottomArea">'+
				'<ul>'+
					'<li>'+
						'<a href="/jikuang/api/main/about.html">关于我们</a>'+
					'</li>'+
					'<li>'+
						'<a href="/jikuang/api/main/about.html?part=1">留言建议</a>'+
					'</li>'+
					'<li>'+
						'<a href="/jikuang/company.html">矿产公司</a>'+
					'</li>'+
					/*'<li>'+
						'<a href="/jikuang/news/tomn.html">矿产动态</a>'+
					'</li>'+*/
					'<li>'+
						'<a href="/jikuang/api/main/about.html?part=2">加入我们</a>'+
					'</li>'+
					'<li>'+
						'<a href="/jikuang/api/main/about.html?part=3">联系我们</a>'+
					'</li>'+
				'</ul>'+
				'<ul>'+
					'<li>'+
		...
		success: function(data){
			if(data.success == true){
				...
				var loginArea = '<div id="loginArea">'+
									...
									'<ul id="topMenu">'+
										'<li onclick="managerCenter()">'+
											'<img src="/jikuang/statics/api/images/navCompany.png">'+
											'<span>管理中心</span>'+
										'</li>'+
										'<li onclick="revisePassword()">'+
											'<img src="/jikuang/statics/api/images/navCompany.png">'+
											'<span>修改密码</span>'+
										'</li>'+
										'<li onclick="logout()">'+
				...
				var menuTitle = '<div id="menuTitle">'+
									...
									'<div id="menuTitleNav">'+
										'<ul>'+
											...
											//'<li><a href="/jikuang/news/tomn.html">矿业资讯</a></li>'+
...
function topMenu(){
	var left = ($('#loginInfo').width() - 50) + 'px';
	$('#topMenu').css('left',left)
