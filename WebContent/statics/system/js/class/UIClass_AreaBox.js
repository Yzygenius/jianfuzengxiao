...
function AreaBox(targetId,typeFlg){
    ...
    $('#city').css('width','240px')
    $('#city text').css('width','160px')
    this.county_CB = new Combox("#county",Combox.TypeArea);
    $('#county').css('width','240px')
    $('#county text').css('width','160px')
    //设置属性
    this.type = typeFlg;
...
AreaBox.prototype.closeOptionPanel = function(){ //关闭面板
	this.province_CB.closeOptionPanel()
	this.city_CB.closeOptionPanel()
	this.county_CB.closeOptionPanel()
}
