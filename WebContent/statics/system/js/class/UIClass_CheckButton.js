...
CheckButton.prototype.iniCheckButton = function(){
    ...
    function mouseLeave(){
		...
		if(thisObj.changePos == true){
			...
			//背景图
			thisObj.btn.css("background", "url('/jikuang/statics/system/images/ui/button_check_mini_normal.png') no-repeat 100% 100%");
		}
	}
    function mouseDown(){
    	...
    	thisObj.btn.offset({top:thisObj.btn.offset().top+2,left:thisObj.btn.offset().left+2});
        //背景图
    	thisObj.btn.css("background", "url('/jikuang/statics/system/images/ui/button_check_mini_press.png') no-repeat 100% 100%");
    }
    function mouseUp(){
		thisObj.btn.unbind("mouseleave",mouseLeave);
		if(thisObj.changePos == true){
...
CheckButton.prototype.setCss = function(){
    ...
    css = {
		...
		"background": "url('/jikuang/statics/system/images/ui/button_check_mini_normal.png') no-repeat 100% 100%",
    }
	this.btn.css(css);
    css = {
    	"vertical-align": "middle",
...
CheckButton.prototype.setCheck = function(checkFlg){
	...
	if(this.checkClick){
		this.img.attr("src","/jikuang/statics/system/images/ui/check.png");
		this.img.attr('checked',true)
	}else{
		this.img.attr("src","/jikuang/statics/system/images/ui/uncheck.png");
...
CheckButton.prototype.setDisable = function(disableFlg){ //设置是否可用
    ...
    if(disableFlg){
        ...
        this.btn.attr("src","/jikuang/statics/system/images/ui/uncheck.png");
    }
}
