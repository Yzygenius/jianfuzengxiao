...
function DateBox(targetId,typeFlg){
    ...
    this.lastYear = new Button(targetId+" #lastYear","/jikuang/statics/system/images/ui/left_double.png","",Button.TypeNormal,Button.SizeMini);
    this.lastMonth = new Button(targetId+" #lastMonth","/jikuang/statics/system/images/ui/left_single.png","",Button.TypeNormal,Button.SizeMini);
    this.nextMonth = new Button(targetId+" #nextMonth","/jikuang/statics/system/images/ui/right_single.png","",Button.TypeNormal,Button.SizeMini);
    this.nextYear = new Button(targetId+" #nextYear","/jikuang/statics/system/images/ui/right_double.png","",Button.TypeNormal,Button.SizeMini);
...
DateBox.prototype.iniCarlendar = function(){ //初始化
    ...
    this.img.attr("src",ImageIcon.Rili_B);
    //
    this.setCss();
    //绑定事件
...
DateBox.prototype.setCss = function(){ //设置样式
    ...
    css = {
        ...
        "height": "307px",
        "display": "none",
        "background": "url('/jikuang/statics/system/images/ui/datebox_bg.png') no-repeat 100% 100%",
    }
...
DateBox.prototype.openDateBox = function(){ //展开日历
    ...
    if(scrolltop==0){
    	scrolltop = this.datebox.parents('#moreSearchAreaMiddle').scrollTop();
    }
...
DateBox.prototype.setBtnStatus = function(tarBtn,dayBtnStatusFlg){ //设置按钮样式
    ...
    switch(dayBtnStatusFlg){
        ...
        case(DateBox.TypeDayBtnEnter):
            css={
                "color": "#333333",
                "background": "url('/jikuang/statics/system/images/ui/datebox_over.png') no-repeat 100% 100%",
            };
            break;
        ...
        case(DateBox.TypeDayBtnSelect):
            css={
                "color": "#ffffff",
                "background": "url('/jikuang/statics/system/images/ui/datebox_sel.png') no-repeat 100% 100%",
            }
            break;
        case(DateBox.TypeDayBtnToday):
            css={
                "color": "#ffffff",
                "background": "url('/jikuang/statics/system/images/ui/datebox_today.png') no-repeat 100% 100%",
            }
            break;
    }
    tarBtn.css(css);
