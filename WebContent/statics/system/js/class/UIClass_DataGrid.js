...
function DataGrid(targetId,gridSetData){
    ...
    this.fpBtn = new Button(targetId +" #fpBtn","/jikuang/statics/system/images/ui/left_double.png","",Button.TypeNormal,Button.SizeShort);
    this.lpBtn = new Button(targetId +" #lpBtn","/jikuang/statics/system/images/ui/left_single.png","",Button.TypeNormal,Button.SizeShort);
    this.npBtn = new Button(targetId +" #npBtn","/jikuang/statics/system/images/ui/right_single.png","",Button.TypeNormal,Button.SizeShort);
    this.epBtn = new Button(targetId +" #epBtn","/jikuang/statics/system/images/ui/right_double.png","",Button.TypeNormal,Button.SizeShort);
    //设置属性
...
DataGrid.prototype.setCss = function(){ //设置样式
    ...
    css = {
        ...
        "width": "378px",
        "height": "34px",
        "background": "url('/jikuang/statics/system/images/ui/datagrid_pageinfo.png') no-repeat 100% 100%",
    }
