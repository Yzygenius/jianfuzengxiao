//列表行设置---------------------------------------------------------------------------------
//政府用户列表
DataGridItemSet.TypeGovermentList = {
	head:{
        ...
        checkBox:{title: '',field: 'companyName',width:"60px",visible:false}
    },
    columns:[
        {title: '机关名称', field: 'companyName', width:"300px",formatter:function(row){
            return "<div style='text-align: left;text-indent: 20px;'><img src='"+ImageIcon.Jiguan_B+
            		"' style='vertical-align:middle;margin-right:10px;width:25px;'></img><span style='vertical-align:middle;'>"+row.companyName+"</span></div>";
        }},
        {title: '姓名', field: 'contactName', width:"150px",formatter:function(row){
            return "<div style='text-align: left;text-indent: 20px;'><img src='"+ImageIcon.Gerenzhongxin_B+
    		"' style='vertical-align:middle;margin-right:10px;width:25px;'></img><span style='vertical-align:middle;'>"+row.contactName+"</span></div>";
        }},
        {title: '职务', field: 'position', width:"200px",formatter:function(row){
            return "<div style='text-align: left;text-indent: 20px;'><img src='"+ImageIcon.Zhiwu_B+
    		"' style='vertical-align:middle;margin-right:10px;width:25px;'></img><span style='vertical-align:middle;'>"+row.position+"</span></div>";
        }},
        {title: '联系电话', field: 'contactTel', width:"200px",formatter:function(row){
            return "<div style='text-align: left;'><img src='"+ImageIcon.Tel_G+
    		"' style='vertical-align:middle;margin-left:10px;width:18px;'></img><span style='vertical-align:middle;margin-left:10px;'>"+row.contactTel+"</span></div>";
        }},
        {title: '行政级别', field: 'accountType', width:"150px",formatter:function(row){
        	if(row.accountType == 'C'){
        		return "<div style='text-align: left;'><img src='"+ImageIcon.Zhizhao_G+
        		"' style='vertical-align:middle;margin-left:10px;width:18px;'></img><span style='vertical-align:middle;margin-left:10px;'>市</span></div>";
        	}else if(row.accountType == 'D'){
        		return "<div style='text-align: left;'><img src='"+ImageIcon.Zhizhao_G+
        		"' style='vertical-align:middle;margin-left:10px;width:18px;'></img><span style='vertical-align:middle;margin-left:10px;'>县</span></div>";
        	}
            
        }},
        {title: '用户名', field: 'username', width:"200px",formatter:function(row){
            return "<div style='text-align: left;'><img src='"+ImageIcon.Yonghuming_G+
            		"' style='vertical-align:middle;margin-left:10px;width:18px;'></img><span style='vertical-align:middle;margin-left:10px;'>"+row.username+"</span></div>";
        }},
        {title: '所属地区', field: 'localArea', width:"300px",formatter:function(row){
        	if(row.accountType == 'C'){//市
        		var localArea = row.provName + row.cityName;
        	}else if(row.accountType == 'D'){//县
        		var localArea = row.provName + row.cityName + row.areaName;
        	}
            return "<div style='text-align: left;'><img src='"+ImageIcon.Dingwei_G+
    		"' style='vertical-align:middle;margin-left:10px;width:18px;'></img><span style='vertical-align:middle;margin-left:10px;'>"+localArea+"</span></div>";
        }},
    ],
    itemClickFun:function(row){
    	new WindowSwitch(WindowSwitch.TypeGovermentDetail,row.companyId);
    },
}
//企业用户列表
DataGridItemSet.TypeEnterpriseList = {
    head:{
        id:{title: '序号',width:"60px",visible:true,formatter:function(val){
            return "<div style='font-weight:bold;font-size:18px;text-align: center;width:40px;line-height:40px;"+
                    "border-radius:10px;color:#ffffff;background:#22b8de;margin:10px auto;box-shadow: 1px 1px 2px #cccccc'>"+
    ...
    columns:[
        {title: '企业名称', field: 'companyName', width:"350px",formatter:function(row){
            return "<div style='text-align: left;text-indent: 20px;'><img src='"+ImageIcon.Gongchang_B+
            		"' style='vertical-align:middle;margin-right:10px;width:25px;'></img><span style='vertical-align:middle;'>"+row.companyName+"</span></div>";
        }},
        {title: '所在地区', field: 'localArea', width:"300px",formatter:function(row){
            return "<div style='text-align: left;'><img src='"+ImageIcon.Dingwei_G+
    		"' style='vertical-align:middle;margin-left:10px;width:18px;'></img><span style='vertical-align:middle;margin-left:10px;'>"+row.provName + row.cityName + row.areaName+"</span></div>";
        }},
        {title: '联系人', field: 'contactName', width:"150px",formatter:function(row){
            return "<div style='text-align: left;'><img src='"+ImageIcon.Touxiang_G+
    		"' style='vertical-align:middle;margin-left:10px;width:18px;'></img><span style='vertical-align:middle;margin-left:10px;'>"+row.contactName+"</span></div>";
        }},
        {title: '联系电话', field: 'contactTel', width:"150px",formatter:function(row){
            return "<div style='text-align: left;'><img src='"+ImageIcon.Tel_G+
            		"' style='vertical-align:middle;margin-left:10px;width:18px;'></img><span style='vertical-align:middle;margin-left:10px;'>"+row.contactTel+"</span></div>";
        }},
        {title: '矿种', field: 'minesType', width:"200px",formatter:function(row){
            return "<div style='text-align: left;'><img src='"+ImageIcon.Xitong_G+
    		"' style='vertical-align:middle;margin-left:10px;width:18px;'></img><span style='vertical-align:middle;margin-left:10px;'>"+row.minesType+"</span></div>";
        }},
        {title: '生产能力（吨/年）', field: 'productionYear', width:"150px",formatter:function(row){
            return "<div style='text-align: left;'><img src='"+ImageIcon.Zhongliang_G+
    		"' style='vertical-align:middle;margin-left:10px;width:18px;'></img><span style='vertical-align:middle;margin-left:10px;'>"+row.productionYear+"</span></div>";
        }},
        {title: '储量（吨）', field: 'reserves', width:"150px",formatter:function(row){
            return "<div style='text-align: left;'><img src='"+ImageIcon.Zhongliang_G+
    		"' style='vertical-align:middle;margin-left:10px;width:18px;'></img><span style='vertical-align:middle;margin-left:10px;'>"+row.reserves+"</span></div>";
        }},
        {title: '企业评级', field: 'enterpriseGrade', width:"150px",formatter:function(row){
        	if(row.enterpriseGrade == 'A'){
        		var enterpriseGradeText = '正面清单企业'
        	}else if(row.enterpriseGrade == 'B'){
        		var enterpriseGradeText = '正面清单申请中'
        	}else if(row.enterpriseGrade == 'C'){
        		var enterpriseGradeText = '知名企业'
        	}else{
        		var enterpriseGradeText = '无'
        	}
            return "<div style='text-align: left;'><img src='"+ImageIcon.Zhizhao_G+
    		"' style='vertical-align:middle;margin-left:10px;width:18px;'></img><span style='vertical-align:middle;margin-left:10px;'>"+enterpriseGradeText+"</span></div>";
        }},
    ],
    itemClickFun:function(row){
    	new WindowSwitch(WindowSwitch.TypeEnterpriseDetail,row.companyId);
    },
}
//普通会员列表
DataGridItemSet.TypeGeneralList = {
    head:{
        id:{title: '序号',width:"60px",visible:true,formatter:function(val){
            return "<div style='font-weight:bold;font-size:18px;text-align: center;width:40px;line-height:40px;"+
                    "border-radius:10px;color:#ffffff;background:#22b8de;margin:10px auto;box-shadow: 1px 1px 2px #cccccc'>"+
    ...
    columns:[
        {title: '会员名称', field: 'companyName', width:"350px",formatter:function(row){
            return "<div style='text-align: left;text-indent: 20px;'><img src='"+ImageIcon.Gerenzhongxin_B+
            		"' style='vertical-align:middle;margin-right:10px;width:25px;'></img><span style='vertical-align:middle;'>"+row.companyName+"</span></div>";
        }},
        {title: '所在地区', field: 'localArea', width:"300px",formatter:function(row){
        ...
        {title: '联系人', field: 'contactName', width:"200px",formatter:function(row){
            return "<div style='text-align: left;'><img src='"+ImageIcon.Touxiang_G+
    		"' style='vertical-align:middle;margin-left:10px;width:18px;'></img><span style='vertical-align:middle;margin-left:10px;'>"+row.contactName+"</span></div>";
        }},
        {title: '联系电话', field: 'contactTel', width:"200px",formatter:function(row){
        ...
        {title: '联系QQ', field: 'qq', width:"200px",formatter:function(row){
            return "<div style='text-align: left;'><img src='"+ImageIcon.QQ_G+
    		"' style='vertical-align:middle;margin-left:10px;width:18px;'></img><span style='vertical-align:middle;margin-left:10px;'>"+row.qq+"</span></div>";
        }},
        {title: '联系微信', field: 'wx', width:"200px",formatter:function(row){
            return "<div style='text-align: left;'><img src='"+ImageIcon.Weixin_G+
            		"' style='vertical-align:middle;margin-left:10px;width:18px;'></img><span style='vertical-align:middle;margin-left:10px;'>"+row.wx+"</span></div>";
        }},
    ],
    itemClickFun:function(row){
		if(row.certState == 'B'){
		  	new WindowSwitch(WindowSwitch.TypeAuditGeneralDetail,row.companyId);
		}else if(row.certState == 'R'){
			new WindowSwitch(WindowSwitch.TypeRejectGeneralDetail,row.companyId);
		}else if(row.certState == 'C'){
			new WindowSwitch(WindowSwitch.TypeGeneralDetail,row.companyId);
		}
    },
}
//企业产品审核列表
DataGridItemSet.TypeAuditEnterpriseProductList = {
  head:{
      id:{title: '序号',width:"60px",visible:true,formatter:function(val){
          return "<div style='font-weight:bold;font-size:18px;text-align: center;width:40px;line-height:40px;"+
                  "border-radius:10px;color:#ffffff;background:#22b8de;margin:10px auto;box-shadow: 1px 1px 2px #cccccc'>"+
  ...
  columns:[
      {title: '产品名称', field: 'productName', width:"350px",formatter:function(row){
          return "<div style='text-align: left;text-indent: 20px;'><img src='"+ImageIcon.Qiyechanpin_B+
          		"' style='vertical-align:middle;margin-right:10px;width:25px;'></img><span style='vertical-align:middle;'>"+row.productName+"</span></div>";
      }},
      {title: '类别', field: 'productType', width:"350px",formatter:function(row){
          return "<div style='text-align: left;text-indent: 20px;'><img src='"+ImageIcon.Xitong_B+
          		"' style='vertical-align:middle;margin-right:10px;width:25px;'></img><span style='vertical-align:middle;'>"+row.productType+"</span></div>";
      }},
      {title: '企业名称', field: 'companyName', width:"350px",formatter:function(row){
          return "<div style='text-align: left;text-indent: 20px;'><img src='"+ImageIcon.Gongchang_B+
          		"' style='vertical-align:middle;margin-right:10px;width:25px;'></img><span style='vertical-align:middle;'>"+row.companyName+"</span></div>";
      }},
      {title: '添加时间', field: 'createTime', width:"350px",formatter:function(row){
          return "<div style='text-align: left;text-indent: 20px;'><img src='"+ImageIcon.Rili_B+
          		"' style='vertical-align:middle;margin-right:10px;width:25px;'></img><span style='vertical-align:middle;'>"+row.createTime+"</span></div>";
      }},
  ],
  itemClickFun:function(row){
		if(row.auditState == 'B'){
		  	new WindowSwitch(WindowSwitch.TypeAuditEnterpriseProductDetail,row.goodsId);
		}else if(row.auditState == 'R'){
			new WindowSwitch(WindowSwitch.TypeRejectEnterpriseProductDetail,row.goodsId);
		}else if(row.auditState == 'C'){
			new WindowSwitch(WindowSwitch.TypeEnterpriseProductDetail,row.goodsId);
		}
  },
}
//企业动态审核列表
DataGridItemSet.TypeAuditEnterpriseNewsList = {
	head:{
	    id:{title: '序号',width:"60px",visible:true,formatter:function(val){
	        return "<div style='font-weight:bold;font-size:18px;text-align: center;width:40px;line-height:40px;"+
	                "border-radius:10px;color:#ffffff;background:#22b8de;margin:10px auto;box-shadow: 1px 1px 2px #cccccc'>"+
	...
	columns:[
	    {title: '标题', field: 'title', width:"650px",formatter:function(row){
	        return "<div style='text-align: left;overflow:hidden;'><img src='"+ImageIcon.Title_B+
	        		"' style='float:left;margin:17.5px 10px;width:25px;'></img><span style='float:left;max-width:590px;overflow:hidden;white-space:nowrap;text-overflow: ellipsis;'>"+row.title+"</span></div>";
	    }},
	    {title: '简介', field: 'introduction', width:"650px",formatter:function(row){
	        return "<div style='text-align: left;overflow:hidden;'><img src='"+ImageIcon.Jianjie_B+
	        		"' style='float:left;margin:17.5px 10px;width:25px;'></img><span style='float:left;max-width:590px;overflow:hidden;white-space:nowrap;text-overflow: ellipsis;'>"+row.introduction+"</span></div>";
	    }},
	    {title: '创建时间', field: 'createTime', width:"150px",formatter:function(row){
	        return "<div style='text-align: left;text-indent: 20px;'><img src='"+ImageIcon.Rili_B+
	        		"' style='vertical-align:middle;margin-right:10px;width:25px;'></img><span style='vertical-align:middle;'>"+row.createTime+"</span></div>";
	    }},
	],
	itemClickFun:function(row){
		if(row.auditState == 'B'){
			new WindowSwitch(WindowSwitch.TypeAuditEnterpriseNewsDetail,row.newsId);
		}else if(row.auditState == 'R'){
			new WindowSwitch(WindowSwitch.TypeRejectEnterpriseNewsDetail,row.newsId);
		}else if(row.auditState == 'C'){
			new WindowSwitch(WindowSwitch.TypeEnterpriseNewsDetail,row.newsId);
		}
	},
}
//生产数据审核列表
DataGridItemSet.TypeAuditProductionDataList = {
	head:{
	    id:{title: '序号',width:"60px",visible:true,formatter:function(val){
	        return "<div style='font-weight:bold;font-size:18px;text-align: center;width:40px;line-height:40px;"+
	                "border-radius:10px;color:#ffffff;background:#22b8de;margin:10px auto;box-shadow: 1px 1px 2px #cccccc'>"+
	...
	columns:[
	    {title: '产品名称', field: 'productName', width:"350px",formatter:function(row){
	        return "<div style='text-align: left;text-indent: 20px;'><img src='"+ImageIcon.Qiyechanpin_B+
	        		"' style='vertical-align:middle;margin-right:10px;width:25px;'></img><span style='vertical-align:middle;'>"+row.goodsName+"</span></div>";
	    }},
	    {title: '产量（吨/天）', field: 'weight', width:"350px",formatter:function(row){
	        return "<div style='text-align: left;text-indent: 20px;'><img src='"+ImageIcon.Zhongliang_B+
	        		"' style='vertical-align:middle;margin-right:10px;width:25px;'></img><span style='vertical-align:middle;'>"+row.weight+"</span></div>";
	    }},
	    {title: '价格（元）', field: 'price', width:"350px",formatter:function(row){
	        return "<div style='text-align: left;text-indent: 20px;'><img src='"+ImageIcon.Yunfei_B+
	        		"' style='vertical-align:middle;margin-right:10px;width:25px;'></img><span style='vertical-align:middle;'>"+row.price+"</span></div>";
	    }},
	    {title: '日期', field: 'createTime', width:"350px",formatter:function(row){
	        return "<div style='text-align: left;text-indent: 20px;'><img src='"+ImageIcon.Rili_B+
	        		"' style='vertical-align:middle;margin-right:10px;width:25px;'></img><span style='vertical-align:middle;'>"+row.createTime+"</span></div>";
	    }},
	],
	itemClickFun:function(row){
		if(row.auditState == 'B'){
			new WindowSwitch(WindowSwitch.TypeAuditProductionDataDetail,row.goodsTrendId);
		}else if(row.auditState == 'R'){
			new WindowSwitch(WindowSwitch.TypeRejectProductionDataDetail,row.goodsTrendId);
		}else if(row.auditState == 'C'){
			new WindowSwitch(WindowSwitch.TypeProductionDataDetail,row.goodsTrendId);
		}
	},
}
//交易信息审核列表
DataGridItemSet.TypeAuditTradeInfoList = {
	head:{
	    id:{title: '序号',width:"60px",visible:true,formatter:function(val){
	        return "<div style='font-weight:bold;font-size:18px;text-align: center;width:40px;line-height:40px;"+
	                "border-radius:10px;color:#ffffff;background:#22b8de;margin:10px auto;box-shadow: 1px 1px 2px #cccccc'>"+
	...
	columns:[
	    {title: '类别', field: 'type', width:"250px",formatter:function(row){
	        return "<div style='text-align: left;text-indent: 20px;'><img src='"+ImageIcon.Xitong_B+
	        		"' style='vertical-align:middle;margin-right:10px;width:25px;'></img><span style='vertical-align:middle;'>"+row.type+"</span></div>";
	    }},
	    {title: '交易类型', field: 'transactionType', width:"150px",formatter:function(row){
	    	if(row.transactionType == 'B'){
	    		var transactionType = '购买'
	    	}else if(row.transactionType == 'S'){
	    		var transactionType = '出售'
	    	}
	        return "<div style='text-align: left;text-indent: 20px;'><img src='"+ImageIcon.Jiaoyileixing_B+
	        		"' style='vertical-align:middle;margin-right:10px;width:25px;'></img><span style='vertical-align:middle;'>"+transactionType+"</span></div>";
	    }},
	    {title: '重量（吨）', field: 'weight', width:"250px",formatter:function(row){
	        return "<div style='text-align: left;text-indent: 20px;'><img src='"+ImageIcon.Zhongliang_B+
	        		"' style='vertical-align:middle;margin-right:10px;width:25px;'></img><span style='vertical-align:middle;'>"+row.weight+"</span></div>";
	    }},
	    {title: '价格（元）', field: 'price', width:"250px",formatter:function(row){
	        return "<div style='text-align: left;text-indent: 20px;'><img src='"+ImageIcon.Yunfei_B+
	        		"' style='vertical-align:middle;margin-right:10px;width:25px;'></img><span style='vertical-align:middle;'>"+row.price+"</span></div>";
	    }},
	    {title: '联系人', field: 'contactName', width:"250px",formatter:function(row){
	        return "<div style='text-align: left;text-indent: 20px;'><img src='"+ImageIcon.Touxiang_B+
	        		"' style='vertical-align:middle;margin-right:10px;width:25px;'></img><span style='vertical-align:middle;'>"+row.contactName+"</span></div>";
	    }},
	    {title: '联系电话', field: 'contactPhone', width:"250px",formatter:function(row){
	        return "<div style='text-align: left;text-indent: 20px;'><img src='"+ImageIcon.Tel_B+
	        		"' style='vertical-align:middle;margin-right:10px;width:25px;'></img><span style='vertical-align:middle;'>"+row.contactPhone+"</span></div>";
	    }},
	    {title: '有效期', field: 'createTime', width:"350px",formatter:function(row){
	        return "<div style='text-align: left;text-indent: 20px;'><img src='"+ImageIcon.Rili_B+
	        		"' style='vertical-align:middle;margin-right:10px;width:25px;'></img><span style='vertical-align:middle;'>"+row.validStartTime+' - '+row.validStopTime+"</span></div>";
	    }},
	],
	itemClickFun:function(row){
		if(row.auditState == 'B'){
			new WindowSwitch(WindowSwitch.TypeAuditTradeInfoDetail,row.transactionId);
		}else if(row.auditState == 'R'){
			new WindowSwitch(WindowSwitch.TypeRejectTradeInfoDetail,row.transactionId);
		}else if(row.auditState == 'C'){
			new WindowSwitch(WindowSwitch.TypeTradeInfoDetail,row.transactionId);
		}
	},
}
//政策法规审核列表
DataGridItemSet.TypeAuditPolicyLawsList = {
	head:{
	    id:{title: '序号',width:"60px",visible:true,formatter:function(val){
	        return "<div style='font-weight:bold;font-size:18px;text-align: center;width:40px;line-height:40px;"+
	                "border-radius:10px;color:#ffffff;background:#22b8de;margin:10px auto;box-shadow: 1px 1px 2px #cccccc'>"+
	...
	itemClickFun:function(row){
		if(row.auditState == 'B'){
			new WindowSwitch(WindowSwitch.TypeAuditPolicyLawsDetail,row.newsId);
		}else if(row.auditState == 'R'){
			new WindowSwitch(WindowSwitch.TypeRejectPolicyLawsDetail,row.newsId);
		}else if(row.auditState == 'C'){
			new WindowSwitch(WindowSwitch.TypePolicyLawsDetail,row.newsId);
		}
	},
}
//留言管理列表
DataGridItemSet.TypeMessageList = {
	head:{
	    id:{title: '序号',width:"60px",visible:true,formatter:function(val){
	        return "<div style='font-weight:bold;font-size:18px;text-align: center;width:40px;line-height:40px;"+
	                "border-radius:10px;color:#ffffff;background:#22b8de;margin:10px auto;box-shadow: 1px 1px 2px #cccccc'>"+
	...
	columns:[
	    {title: '联系人', field: 'contactName', width:"200px",formatter:function(row){
	        return "<div style='text-align: left;overflow:hidden;'><img src='"+ImageIcon.Touxiang_B+
	        		"' style='float:left;margin:17.5px 10px;width:25px;'></img><span style='float:left;max-width:590px;overflow:hidden;white-space:nowrap;text-overflow: ellipsis;'>"+row.contactName+"</span></div>";
	    }},
	    {title: '联系电话', field: 'contactTel', width:"250px",formatter:function(row){
	        return "<div style='text-align: left;overflow:hidden;'><img src='"+ImageIcon.Tel_B+
	        		"' style='float:left;margin:17.5px 10px;width:25px;'></img><span style='float:left;max-width:590px;overflow:hidden;white-space:nowrap;text-overflow: ellipsis;'>"+row.contactTel+"</span></div>";
	    }},
	    {title: '联系邮箱', field: 'email', width:"250px",formatter:function(row){
	    	if(row.email != undefined){
	    		return "<div style='text-align: left;overflow:hidden;'><img src='"+ImageIcon.Email_B+
	        			"' style='float:left;margin:17.5px 10px;width:25px;'></img><span style='float:left;max-width:590px;overflow:hidden;white-space:nowrap;text-overflow: ellipsis;'>"+row.email+"</span></div>";
	    	}
	    }},
	    {title: '创建时间', field: 'createTime', width:"300px",formatter:function(row){
	        return "<div style='text-align: left;text-indent: 20px;'><img src='"+ImageIcon.Rili_B+
	        		"' style='vertical-align:middle;margin-right:10px;width:25px;'></img><span style='vertical-align:middle;'>"+row.createTime+"</span></div>";
	    }},
	],
	itemClickFun:function(row){
		new WindowSwitch(WindowSwitch.TypeMessageDetail,row.messageId);
	},
}
//广告管理列表
DataGridItemSet.TypeAdList = {
	head:{
	    id:{title: '序号',width:"60px",visible:true,formatter:function(val){
	        return "<div style='font-weight:bold;font-size:18px;text-align: center;width:40px;line-height:40px;"+
	                "border-radius:10px;color:#ffffff;background:#22b8de;margin:10px auto;box-shadow: 1px 1px 2px #cccccc'>"+
	...
	columns:[
	    {title: '图片', field: 'adImage', width:"300px",formatter:function(row){
	        return "<div style='text-align: left;overflow:hidden;'>" +
	        	   "<img class='adImage' src='/jikuang/"+row.imgThumb+
	        	   "' style='display:block;margin:0 auto;height:50px;'></img></div>";
	    }},
	    {title: '显示状态', field: 'isEnable', width:"200px",formatter:function(row){
	    	if(row.isEnable == 'Y'){
	    		var state = '显示'
	    	}else if(row.isEnable == 'N'){
	    		var state = '不显示'
	    	}
	        return "<div style='text-align: left;overflow:hidden;'><img src='"+ImageIcon.Zhuangtai_B+
	        		"' style='float:left;margin:17.5px 10px;width:25px;'></img><span style='float:left;max-width:590px;overflow:hidden;white-space:nowrap;text-overflow: ellipsis;'>"+state+"</span></div>";
	    }},
	    {title: '显示顺序', field: 'listOrder', width:"200px",formatter:function(row){
	    	return "<div style='text-align: left;overflow:hidden;'><img src='"+ImageIcon.Zhuangtai_B+
	        		"' style='float:left;margin:17.5px 10px;width:25px;'></img><span style='float:left;max-width:590px;overflow:hidden;white-space:nowrap;text-overflow: ellipsis;'>"+row.listOrder+"</span></div>";
	    	
	    }},
	    {title: '修改时间', field: 'createTime', width:"300px",formatter:function(row){
	        return "<div style='text-align: left;text-indent: 20px;'><img src='"+ImageIcon.Rili_B+
	        		"' style='vertical-align:middle;margin-right:10px;width:25px;'></img><span style='vertical-align:middle;'>"+row.createTime+"</span></div>";
	    }},
	],
	doFunction:function(row){
		$('.adImage').click(function(){
			new WindowPanel().showImage("广告图片",$(this).attr('src'),'');
		})
	},
	itemClickFun:function(row){
		new WindowSwitch(WindowSwitch.TypeAdDetail,row.carouselId);
	},
}
