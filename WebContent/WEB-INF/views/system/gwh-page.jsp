...
<body>
	...
	<div class="x-body">
		...
		<button class="layui-btn"
			onclick="banner_add('新增','/jianfuzengxiao/system/gwh/toAddGwh.html', 780, 435)">
		...
		<c:if test="${sessionScope.SESSION_ADMIN.roleId == 1}">
			...
			<td class="td-manage">
				<button class="layui-btn layui-btn layui-btn-xs"
					onclick="banner_details(this,'查看','/jianfuzengxiao/system/gwh/toGwhDetail.html', 1000, 620)">
					<i class="layui-icon">&#xe615;</i>查看
				</button>
				<c:if test="${sessionScope.SESSION_ADMIN.roleId == 1}">
				<button class="layui-btn layui-btn layui-btn-xs"
					onclick="banner_edit(this,'编辑','/jianfuzengxiao/system/gwh/toUpdateGwh.html', 780, 435)">
	...
	<script>
		...
		function page() {
			$.ajax({
				url : "/jianfuzengxiao/system/gwh/getGwhPage.html",
				type : 'post',
				dataType : "json",
		...
		function delAll() {
			layer.confirm('确认要删除吗？', function(index) {
				...
				var sel = arr.join(",");
				$.ajax({
					url : "/jianfuzengxiao/system/gwh/delGwh.html",
					type : 'post',
					dataType : "json",
					data : {
						'gwhId' : sel
		...
		function banner_details(obj, title, url, w, h) {
			...
			x_admin_show(title, url + '?gwhId=' + id, w, h);
		}
		// 编辑
