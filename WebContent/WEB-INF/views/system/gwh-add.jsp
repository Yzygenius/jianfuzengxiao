	...
	<div class="x-body">
		<form class="layui-form">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" id="gwhName" name="gwhName" required="" lay-verify="required" autocomplete="off" class="layui-input">
				</div>
				<div class="layui-form-mid layui-word-aux">
					<span class="x-red">*</span>
				</div>
			...
			<!-- <div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" id="listOrder" name="listOrder" required="" lay-verify="required" autocomplete="off" class="layui-input">
...
<script>
    ...
    layui.use(['form','layer','upload'], function(){
		...
		form.on('submit(add)', function(data){
		  	...
		  	$.ajax({  
				url : "/jianfuzengxiao/system/gwh/addGwh.html",  
				type : 'post',
				dataType: "json",
				data: {
					'gwhName': $('#gwhName').val(),
