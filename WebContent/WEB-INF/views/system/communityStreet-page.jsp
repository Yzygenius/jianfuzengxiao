...
<body>
	...
	<div class="x-body">
		...
		<button class="layui-btn"
			onclick="banner_add('新增','/jianfuzengxiao/system/communityStreet/toAddCommunityStreet.html', 500, 520)">
	...
	<table id="clone-tr" style="display: none;">
		<tr>
			...
			<td class="td-manage">
				...
				<button class="layui-btn layui-btn layui-btn-xs"
					onclick="banner_edit(this,'编辑','/jianfuzengxiao/system/communityStreet/toUpdateCommunityStreet.html', 500, 520)">
