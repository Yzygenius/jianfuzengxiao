...
<body>
	<input id="id" type="hidden" value="${gwh.gwhId }">
	<div class="x-body">
		<form class="layui-form" lay-filter="example">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" id=gwhName name="gwhName" value="${gwh.gwhName }" required="" autocomplete="off" class="layui-input">
				</div>
				<div class="layui-form-mid layui-word-aux">
					<span class="x-red">*</span>
				</div>
			...
			<%-- <div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" id="listOrder" name="listOrder" value="${gwh.listOrder }" required="" autocomplete="off" class="layui-input">
...
layui.use(['form','layer'], function(){
    ...
    var provCode = ${gwh.provCode };
    var cityCode = ${gwh.cityCode };
    var areaCode = ${gwh.areaCode };
  ...
  form.on('submit(update)', function(data){
      $.ajax({  
		url : "/jianfuzengxiao/system/gwh/updateGwh.html",  
		type : 'post',
		dataType: "json",
		data: {
			'gwhId': $('#id').val(),
