		...
		<form class="layui-form" lay-filter="example">
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" id="productName" name="productName" required="" value="${product.productName}" lay-verify="required" autocomplete="off" class="layui-input">
				</div>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" id="listOrder" name="listOrder" required="" value="${product.listOrder}"
				...
				<div class="layui-input-inline">
					<div class="layui-upload">
					  ...
					  <div class="layui-upload-list">
					    <img width="400" src="/tchyuanlin/${product.img }" class="layui-upload-img" id="img">
					  </div>
					</div>  
				</div>
			</div>
...
$.ajax({  
	url : "/tchyuanlin/system/product/getProductDetails.html",  
	type : 'post',
	dataType: "json",
	data: {
	...
	success : function(result){
		editor.setValue(result.productRemark)
	}
});

	var saveName = '${product.img}';
	var fileId = '${product.imgFile}';
    ...
    layui.use(['form','layer','upload'], function(){
      ...
      form.on('submit(update)', function(data){
    	 // console.log(data)
          $.ajax({  
			url : "/tchyuanlin/system/product/updateProduct.html",  
			type : 'post',
			dataType: "json",
			data: {
				'productId': $('#productId').val(),
