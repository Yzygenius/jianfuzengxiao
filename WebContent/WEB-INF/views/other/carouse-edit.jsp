...
<body>
	<input id="carouselId" type="hidden" value="${carousel.carouselId }">
	<div class="x-body">
		<form class="layui-form">
				...
				<div class="layui-input-inline">
					<div class="layui-upload">
					  ...
					  <div class="layui-upload-list">
					    <img width="400" class="layui-upload-img" id="img" src="/tchyuanlin/${carousel.img }">
					  </div>
					</div>  
				</div>
			</div>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" id="remark" name="remark" required=""
						lay-verify="required" autocomplete="off" class="layui-input" value="${carousel.remark }">
				</div>
			...
			<div class="layui-form-item">
			    ...
			    <div class="layui-input-inline">
			    	<c:if test="${carousel.isEnable == 'Y'}">
			    		<input type="checkbox" checked name="open" lay-skin="switch" lay-filter="switchTest" lay-text="ON|OFF">
			    	</c:if>
			      	<c:if test="${carousel.isEnable == 'N'}">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" id="listOrder" name="listOrder" required=""
						lay-verify="required" autocomplete="off" class="layui-input" value="${carousel.listOrder }">
...
<script>
var saveName = '${carousel.img}'; 
var fileId = '${carousel.imgFile}';
