		...
		<form class="layui-form">
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" id="title" name="title" lay-verify="required" value="${news.title }" required="" autocomplete="off" class="layui-input">
				</div>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" id="listOrder" lay-verify="required" name="listOrder" value="${news.listOrder }" required="" autocomplete="off" class="layui-input">
				</div>
				<div class="layui-form-mid layui-word-aux">
				</div>
			</div>
				...
				<div class="layui-input-inline">
					<div class="layui-upload">
					  ...
					  <div class="layui-upload-list">
					    <img width="200" src="/tchyuanlin/${news.cover }" class="layui-upload-img" id="img">
					  </div>
					</div>  
				</div>
			</div>
...
var editor = new Simditor({
   ...
   // defaultImage: '/simditor/images/image.png',//编辑器插入的默认图片，此处可以删除
	...
	var saveName, fileId, listOrder;
	$.ajax({  
		url : "/tchyuanlin/system/news/getNewsDetails.html",  
		type : 'post',
		dataType: "json",
		data: {
			'newsId': $('#newsId').val(),
...
layui.use(['form','layer','upload'], function(){
  ...
  form.on('submit(update)', function(data){
      $.ajax({  
		url : "/tchyuanlin/system/news/updateNews.html",  
		type : 'post',
		dataType: "json",
		data: {
			'newsId': $('#newsId').val(),
