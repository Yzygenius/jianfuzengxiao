...
<body>
	<input id="producttypeId" type="hidden" value="${productType.producttypeId }">
	<div class="x-body">
		<form class="layui-form">
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" id="typeName" name="typeName" value="${productType.typeName }" required="" lay-verify="required" autocomplete="off" class="layui-input">
				</div>
...
<script>
    ...
    layui.use(['form','layer','upload'], function(){
      ...
      form.on('submit(update)', function(data){
          $.ajax({  
			url : "/tchyuanlin/system/productType/updateProductType.html",  
			type : 'post',
			dataType: "json",
			data: {
