...
public class AdminInfoSDAO extends BaseDAO<AdminInfoMVO> implements IAdminInfoSDAO {
	...
	public AdminInfoMVO insert(final AdminInfoMVO entity) throws SysException {
		...
		sql.append(
				"INSERT INTO ADMIN_INFO (admin_id,login_name,password,satl,username,gender,birth_date,nation_id,nation_name,telephone,role_id,role_name,is_wx,wx_openid,wx_photo,wx_time,wx_password,create_time,update_time,sts) ");
		sql.append(
